...
from .models import Patient, TherapyMedicalRecord, Diagnosis, Therapy, Medication, ArterialPressure, MedicationControl, FoodControl, WeightControl, FoodIngestion, FoodDaily, FoodDailyType, MedicalRecord, NurseCarerRecord
...
admin.site.register(NurseCarerRecord)
